  ...
  variants: {
    variant: {
      stroke: {
        root: [
          // base
          'border border-stroke-lighter bg-bg-white-0 text-text-base shadow-regular-xs',
          // hover
          'hover:border-transparent hover:bg-bg-light hover:text-text-dark hover:shadow-none',
          // focus
          'focus-visible:border-transparent focus-visible:bg-bg-dark focus-visible:text-text-white focus-visible:shadow-none',
        ],
      },
      ghost: {
        root: [
          ...
          // focus
          'focus-visible:bg-bg-dark focus-visible:text-text-white',
        ],
      },
      white: {
        root: [
          // base
          'bg-bg-white text-text-base shadow-regular-xs',
          // hover
          'hover:bg-bg-light hover:text-text-dark',
          // focus
          'focus-visible:bg-bg-dark focus-visible:text-text-white',
