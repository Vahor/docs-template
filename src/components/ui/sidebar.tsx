			...
			<SidebarContext.Provider value={contextValue}>
				<TooltipProvider delayDuration={0}>
					<div
						...
						className={cn(
							"group/sidebar-wrapper flex flex-col min-h-[calc(100svh-theme(spacing.14))]  w-full has-[[data-variant=inset]]:bg-sidebar",
							className,
						)}
						ref={ref}
						{...props}
	...
	(
		...
		return (
			...
			>
				...
				<div
					className={cn(
						"duration-100 relative h-[calc(100svh-theme(spacing.14))] w-[--sidebar-width] bg-transparent transition-[width] ease-linear",
				...
				<div
					className={cn(
						"duration-100 fixed bottom-0 top-14 h-[calc(100svh-3.5rem)] z-10 hidden w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex",
						side === "left"
							? "left-0 group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)]"
							: "right-0 group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)]",
						"group-data-[collapsible=icon]:w-[--sidebar-width-icon] group-data-[side=left]:border-r border-border/30 group-data-[side=right]:border-l",
						className,
					)}
					{...props}
				>
...
>(({ className, ...props }, ref) => {
	return (
		<main
			ref={ref}
			className={cn(
				"relative flex h-[calc(100svh-theme(spacing.14))] flex-1 flex-col bg-background",
				" md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow @container",
				className,
			)}
			{...props}
		/>
