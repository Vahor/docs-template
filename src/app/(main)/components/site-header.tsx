...
export function SiteHeader() {
  return (
    <header className="flex sticky top-[var(--banner-height)] z-50 w-full items-center border-b bg-navbar">
      <div className="flex h-[var(--header-height)] w-full items-center gap-2 px-4">
        ...
        <div className="flex items-center gap-2 mr-4 shrink-0">
          ...
          <div className="hidden sm:grid text-sm leading-tight">
            ...
            <span className="text-paragraph-xs text-text-base">Documentation</span>
          </div>
        </div>
